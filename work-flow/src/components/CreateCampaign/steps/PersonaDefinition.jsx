...
import { User, Briefcase, MessageSquare, FileText, ShoppingCart, Headphones, ClipboardList } from 'lucide-react';
...
const CAMPAIGN_TYPES = [
  { 
    ...
    label: 'Sales', 
    icon: ShoppingCart,
    description: 'Drive conversions and close deals',
    color: 'blue'
  },
  { 
    value: 'support', 
    label: 'Support', 
    icon: Headphones,
    description: 'Help customers solve problems',
    color: 'green'
  },
  { 
    value: 'survey', 
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
            ...
            return (
              <button
                ...
                className={`relative p-4 border-2 rounded-lg transition-all duration-200 ${
                  isSelected 
                    ? colors.selected + ' shadow-md transform scale-105' 
                    : 'bg-white border-gray-200 hover:bg-gray-50 ' + colors.hover
                } ${isFieldInvalid('campaignType') ? 'border-red-300' : ''}`}
              >
                <div className="flex flex-col items-center space-y-2">
                  ...
                  <div className="text-center">
                    <div className={`font-semibold text-sm ${isSelected ? '' : 'text-gray-900'}`}>
                      {type.label}
                    </div>
                ...
                {isSelected && (
                  <div className={`absolute top-2 right-2 w-5 h-5 rounded-full flex items-center justify-center ${colors.badge}`}>
        ...
        {isFieldInvalid('campaignType') && (
          <p className="text-red-600 text-sm">Please select a campaign type</p>
        )}
      </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-red-700 text-sm mt-1">
                Campaign Type, Name, Position, and Tone are required to proceed.
              </p>
            </div>
          </div>
        </div>
