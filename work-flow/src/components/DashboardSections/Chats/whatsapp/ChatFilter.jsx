...
const ChatFilter = ({
  ...
  statusFilter,
  setStatusFilter,
  campaignTypeFilter, // New prop for Campaign Type
  setCampaignTypeFilter, // New prop setter
  campaignFilter, // New prop for specific Campaign
  setCampaignFilter, // New prop setter
  title = 'WhatsApp Chats',
  theme = 'whatsapp'
}) => {
  const statusOptions = ['All', 'Active', 'Closed', 'Paused', 'Draft', 'Assign to me'];
  const campaignTypeOptions = ['All Types', 'Sales', 'Support', 'Survey'];
  
  // Mock data for specific campaigns
  const campaignOptions = ['All Campaigns', 'Summer Sale', 'Product Launch', 'Holiday Special', 'New User Onboarding'];
  ...
  return (
    <div className="p-4 border-b border-gray-200">
      ...
      <div className="relative mb-3">
        ...
        <input
          type="text"
          placeholder="Search chats by name or topic..."
          value={searchTerm}
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        {/* Campaign Filter (New, spanning both columns if needed, but keeping it in the grid for now) */}
