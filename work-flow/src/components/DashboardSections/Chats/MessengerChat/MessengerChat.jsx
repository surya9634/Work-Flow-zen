...
const MessengerChat = () => {
  ...
  const handleAskAI = async () => {
    if (!aiQuestion.trim() || aiAnswerLoading) return;
  ...
  return (
    // Outer container - Apply gradient style
    <div 
    ...
    >
      <div className="flex h-full">
        ...
        <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
          {/* Header (Keep white for visual separation from gradient body) */}
        ...
        <div className="flex-1 flex flex-col bg-gray-50">
          {selectedContact ? (
            <>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <img
                      ...
                      onError={(e) => { e.target.onerror = null; e.target.src = `https://unavatar.io/${encodeURIComponent(selectedContact.name || 'user')}`; }}
                    />
                    <div>
              ...
              {/* Messages */}
              {/* NOTE: Ensuring this container uses flex-1 and overflow-y-auto is CRITICAL for stability */}
        ...
        {/* Right Panel - AI Tools and Profile - FIXED LAYOUT (Apply gradient style) */}
        <div className="w-80 border-l border-gray-200 flex flex-col" style={BLUE_GRADIENT_STYLE}>
          {/* AI Tools Section */}
