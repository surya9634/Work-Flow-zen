...
// Define a consistent height for the chart area and activity list
const CHART_HEIGHT_PX = '400px'; 
const CHART_HEIGHT_CLASS = 'h-[400px]'; // Tailwind class for 400px height
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Charts and Activity (Consistent Height and Gradient Applied) */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          {/* Engagement Chart Wrapper (Spans 2 cols) */}
          <div className="lg:col-span-2" style={BLUE_GRADIENT_STYLE}>
            <EngagementChart
              selectedPeriod={selectedPeriod}
              onPeriodChange={setSelectedPeriod}
              // Pass the desired height down to the chart component
              chartHeight={CHART_HEIGHT_PX}
              chartHeightClass={CHART_HEIGHT_CLASS}
            />
          </div>
          
          {/* Recent Activity Wrapper (Spans 1 col) */}
          <div className="lg:col-span-1" style={BLUE_GRADIENT_STYLE}>
            <RecentActivity 
              activities={recentActivityData} 
              // Pass the desired height down to the activity list
              chartHeightClass={CHART_HEIGHT_CLASS}
            />
          </div>
        </div>
