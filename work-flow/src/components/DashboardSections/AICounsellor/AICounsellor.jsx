...
const AICounsellor = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      // Try to fetch stored system prompt via a dedicated endpoint
      try {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 space-y-6">
      ...
      {/* Control Panel Card (Select, Analyze Button, System Prompt) */}
      <div 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
          ...
          <div className="flex md:justify-end">
            <button
              ...
              className={`w-full md:w-auto px-4 py-2 rounded-lg text-white font-medium ${(!selectedId || analyzing) ? 'bg-gray-400' : 'bg-blue-600 hover:bg-blue-700'} transition-colors`}
            >
